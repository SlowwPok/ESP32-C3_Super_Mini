...
static const RGBMode modes[] = {
    ...
    // ========================================================================
    // РЕЖИМ 7: Кіберпанківський гліч 2 (Cyberpunk Glitch) - СЛУЖБОВИЙ
    // ========================================================================
    // Опис: Неонові кольори для гліч-ефекту.
    // Використовується як основа для анімованого гліч-режиму.
    // Не доступний для прямого вибору.
    ...
    // Смуга 2: Електричний блакитний
    {
        ...
        .perPixel = {
            {   // Смуга 1: Неоновий маджента
                {0, 0, 0},      // Фіолетово-рожевий
                {0, 0, 0},      // Яскраво-фіолетовий
                {0, 0, 0},     // Рожевий
                {0, 0, 0},      // Світло-рожевий
                {0, 0, 0},      // Помаранчево-рожевий
                {0, 0, 0},      // Темно-рожевий
                {0, 0, 0},       // Бордово-рожевий
                {0, 0, 0}        // Темно-бордовий
            },
            {   // Смуга 2: Електричний блакитний
                {0, 0, 0},      // Блакитний
                {0, 0, 0},      // Світло-блакитний
                {0, 0, 0},      // Блакитний
                {0, 0, 0},      // Темно-блакитний
                {0, 0, 0},       // Синьо-блакитний
                {0, 0, 0},       // Темно-синьо-блакитний
                {0, 0, 0},      // Світло-блакитний
                {0, 0, 0}       // Блакитний
            }
        }
    ...
    // ========================================================================
    // РЕЖИМ 8: Анімований - Гліч над неоном (Glitch over Neon)
    // ========================================================================
    // Опис: Гліч-анімація над неоновими кольорами.
    // Створює ефект цифрового збою з неоновими спалахами.
    // Використовує кіберпанківський гліч (режим 5) як основу.
    {
        ...
        .brightness = 40,            // Яскравість: 40%
        .animated = {
            .baseModeIndex = 7,     // Використовує режим 7 як основу (неоновий гліч)
            .anim = {
                .type = ANIM_GLITCH,        // Тип анімації: гліч
                .speedMs = 90,              // Швидкість анімації: 90 мс між кадрами
                .syncStrips = false,         // Синхронізація: так
                .invertSecond = false,      // Додатковий параметр (не використовується)
                .intensity = 4              // Параметр глічу: м'який гліч (soft glitch)
            }
        }
