...
static const RGBMode modes[] = {
    ...
    // Колір: Теплий помаранчевий з відтінком жовтого.
    {
        ...
        .solid = {
            {255, 180, 120},        // Основний колір: теплий помаранчевий
            {255, 160, 100}         // Альтернативний колір (якщо потрібно)
        }
    },
    ...
    // Колір: Темно-коричневий з відтінком.
    {
        ...
        .solid = {
            {60, 40, 25},           // Основний колір: темний теплий
            {60, 40, 25}            // Альтернативний колір (той самий)
        }
    },
    ...
    // Смуга 2: Від блакитного до фіолетового
    {
        ...
        .perPixel = {
            {   // Смуга 1: Градієнт від червоного до зеленого
                {255, 0, 0},        // Червоний
                {255, 80, 0},       // Помаранчево-червоний
                {255, 160, 0},      // Помаранчевий
                {255, 220, 0},      // Жовто-помаранчевий
                {220, 255, 0},      // Жовто-зелений
                {160, 255, 0},      // Світло-зелений
                {80, 255, 0},       // Зелений
                {0, 255, 0}         // Яскраво-зелений
            },
    ...
    // ========================================================================
    // РЕЖИМ 7: Вимкнута стрічка - СЛУЖБОВИЙ
    // ========================================================================
    // Опис: Вимкнута стрічка
    // Використовується як основа а не додатковий режим.
    // Не доступний для прямого вибору.
    // Смуга 1: без кольору = вимкнутий
    // Смуга 2: без кольору = вимкнутий
    {
        .selectable = false,         // Режим не доступний для вибору (службовий)
        .type = MODE_PER_PIXEL,      // Тип режиму: окремий колір на кожен піксель
        .brightness = 0,            // Яскравість: 0%
        .perPixel = {
            {   // Смуга 1: без кольору
                {0, 0, 0},      // без кольору
                {0, 0, 0},      // без кольору
    ...
    // ========================================================================
    // РЕЖИМ 8: Анімований - Гліч над вимкнутою стрічкою (Glitch over Black)
    // ========================================================================
    // Опис: Гліч-анімація над вимкнутою стрічкою.
    // Створює ефект цифрового збою з спалахами.
    // Використовує вимкнуту стрічку (режим 7) як основу.
    {
        .selectable = true,          // Режим доступний для вибору
        .type = MODE_ANIMATED,       // Тип режиму: анімований
        .brightness = 40,            // Яскравість: 40%
        .animated = {
            .baseModeIndex = 7,     // Використовує режим 7 як основу (вимкнута стрічка)
            .anim = {
                .type = ANIM_GLITCH,        // Тип анімації: гліч
                .speedMs = 90,              // Швидкість анімації: 90 мс між кадрами
